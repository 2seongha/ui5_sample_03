		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zc6moduleempzemp01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zc6moduleempzemp01-display": {
								"semanticObject": "zc6moduleempzemp01",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zc6.module.emp.zemp01",
									"url": sap.ui.require.toUrl("zc6/module/emp/zemp01")
								}
							}
						}
					}
